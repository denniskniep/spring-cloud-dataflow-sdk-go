...
// DefinitionsRequestBuilder builds and executes requests for operations under \tasks\definitions
...
type DefinitionsRequestBuilderGetQueryParameters struct {
    ...
    // 
    DslText *string `uriparametername:"dslText"`
    // 
    ...
    // 
    TaskName *string `uriparametername:"taskName"`
}
...
// ByName gets an item from the github.com/denniskniep/spring-cloud-dataflow-sdk-go/v2/client.tasks.definitions.item collection
...
func NewDefinitionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DefinitionsRequestBuilder) {
    m := &DefinitionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tasks/definitions{?pageable*,search*,taskName*,description*,manifest*,dslText*,assembler*,name*,definition*}", pathParameters),
    }
    return m
}
...
func (m *DefinitionsRequestBuilder) Post(ctx context.Context, requestConfiguration *DefinitionsRequestBuilderPostRequestConfiguration)([]byte, error) {
