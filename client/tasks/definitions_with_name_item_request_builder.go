...
// DefinitionsWithNameItemRequestBuilder builds and executes requests for operations under \tasks\definitions\{name}
type DefinitionsWithNameItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// DefinitionsWithNameItemRequestBuilderDeleteQueryParameters 
type DefinitionsWithNameItemRequestBuilderDeleteQueryParameters struct {
    // 
    Cleanup *bool `uriparametername:"cleanup"`
}
...
type DefinitionsWithNameItemRequestBuilderDeleteRequestConfiguration struct {
    ...
    QueryParameters *DefinitionsWithNameItemRequestBuilderDeleteQueryParameters
}
// DefinitionsWithNameItemRequestBuilderGetQueryParameters 
type DefinitionsWithNameItemRequestBuilderGetQueryParameters struct {
    // 
    Manifest *bool `uriparametername:"manifest"`
}
...
type DefinitionsWithNameItemRequestBuilderGetRequestConfiguration struct {
    ...
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *DefinitionsWithNameItemRequestBuilderGetQueryParameters
}
...
func NewDefinitionsWithNameItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DefinitionsWithNameItemRequestBuilder) {
    m := &DefinitionsWithNameItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tasks/definitions/{name}{?manifest*,cleanup*}", pathParameters),
    }
    return m
}
