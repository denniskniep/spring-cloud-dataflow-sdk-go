...
// ByVersion gets an item from the dataflow/client.streams.deployments.rollback.item.item collection
...
// ByVersionInteger gets an item from the dataflow/client.streams.deployments.rollback.item.item collection
