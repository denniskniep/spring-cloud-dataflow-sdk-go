...
import (
    ...
    i074ec5fe860645346e705bbef0c10216723e68244bab0eb79bab9ccda3dbddb6 "dataflow/client/jobs/executions"
)
...
type ExecutionsRequestBuilderGetQueryParameters struct {
    ...
    // 
    StatusAsGetStatusQueryParameterType *i074ec5fe860645346e705bbef0c10216723e68244bab0eb79bab9ccda3dbddb6.GetStatusQueryParameterType `uriparametername:"status"`
}
...
// ByExecutionsId gets an item from the dataflow/client.jobs.executions.item collection
...
// ByExecutionsIdInt64 gets an item from the dataflow/client.jobs.executions.item collection
...
func (m *ExecutionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ExecutionsRequestBuilderGetRequestConfiguration)(i320978ecdc392613ad9c6b55a6f9f5639a92533af8a2d757ef66f9a633865c3f.PagedModelJobExecutionResourceable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i320978ecdc392613ad9c6b55a6f9f5639a92533af8a2d757ef66f9a633865c3f.CreatePagedModelJobExecutionResourceFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i320978ecdc392613ad9c6b55a6f9f5639a92533af8a2d757ef66f9a633865c3f.PagedModelJobExecutionResourceable), nil
}
